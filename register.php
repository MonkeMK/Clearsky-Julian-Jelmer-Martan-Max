                ...
                <div class="col-sm-6 text-black">
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        ...
                        <form id="registerForm" style=" position:absolute; width: 23rem; top: 9%;" method="POST">
                            ...
                            <div class="pt-1 mb-4">
                                <button style="left:60%;" class="btn btn-info btn-lg btn-block" type="button"
                                    onclick="validateForm()">Registeer</button>
                            </div>

                            <a href="login.php">
                                <div class="pt-12 mb-4">
                                    <button style="position:absolute; left: 5%; bottom:-3.5%;"
                                        class="btn btn-info btn-lg btn-block" type="submit">Terug naar login</button>
                                </div>
                            </a>
                        </form>
                    </div>
